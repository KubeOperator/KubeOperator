INSERT INTO `ko`.`ko_user`(`created_at`, `updated_at`, `id`, `name`, `password`, `email`, `is_active`, `language`, `is_admin`) VALUES (date_add(now(), interval 8 HOUR), date_add(now(), interval 8 HOUR), '5e81095f-3c0c-4cb2-8033-bde03d60135c', 'admin', '47zHCOqO84rdzGgxw5XPfgDEapoOMXbgJnryG32xp6Y=', 'admin@fit2cloud.com', 1, 'zh-CN', 1);
