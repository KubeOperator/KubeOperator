...
INSERT INTO `ko`.`ko_cluster_tool_detail`(`id`, `name`, `version`, `chart_version`, `architecture`, `describe`, `vars`, `created_at`, `updated_at`) VALUES (
    UUID(), 'kubepi', 'v1.0.1', '1.0.1', 'all', NULL, '{\"kubepi_image_name\":\"kubeoperator/kubepi-server\",\"kubepi_image_tag\":\"v1.0.1\"}', date_add(now(), interval 8 HOUR), date_add(now(), interval 8 HOUR));
