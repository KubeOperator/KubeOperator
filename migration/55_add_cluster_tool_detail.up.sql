...
INSERT INTO `ko`.`ko_cluster_tool_detail`(`id`, `name`, `version`, `chart_version`, `architecture`, `describe`, `vars`, `created_at`, `updated_at`) VALUES (
    UUID(), 'loki', 'v2.1.0', '2.0.0', 'arm64', NULL, '{\"loki_image_name\":\"grafana/loki\",\"loki_image_tag\":\"2.1.0-arm64\",\"promtail_image_name\":\"grafana/promtail\",\"promtail_image_tag\":\"2.1.0-arm64\"}', date_add(now(), interval 8 HOUR), date_add(now(), interval 8 HOUR));
INSERT INTO `ko`.`ko_cluster_tool_detail`(`id`, `name`, `version`, `chart_version`, `architecture`, `describe`, `vars`, `created_at`, `updated_at`) VALUES (
    UUID(), 'loki', 'v2.1.0', '2.0.0', 'amd64', NULL, '{\"loki_image_name\":\"grafana/loki\",\"loki_image_tag\":\"2.1.0-amd64\",\"promtail_image_name\":\"grafana/promtail\",\"promtail_image_tag\":\"2.1.0-amd64\"}', date_add(now(), interval 8 HOUR), date_add(now(), interval 8 HOUR));
...
INSERT INTO `ko`.`ko_cluster_tool_detail`(`id`, `name`, `version`, `chart_version`, `architecture`, `describe`, `vars`, `created_at`, `updated_at`) VALUES (
    UUID(), 'kubeapps', 'v2.0.1', '5.0.1', 'amd64', NULL, '{\"postgresql_image_name\":\"postgres\",\"postgresql_image_tag\":\"11-alpine\"}', date_add(now(), interval 8 HOUR), date_add(now(), interval 8 HOUR));
