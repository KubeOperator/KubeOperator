...
-  [:tv:10分钟演示视频]( https://kubeoperator-1256577600.file.myqcloud.com/video/KubeOperator2.1.mp4)：从 Kubernetes 集群 Day 0 规划，到 Day 1 部署，到 Day 2 运维和变更，详细演示 KubeOperator 的功能。
