...
KubeOperator 是一个开源项目，帮助运维人员通过 Web-based UI，在完全离线环境下部署和管理生产级别的 Kubernetes 集群。KubeOperator 尤其适合在私有云平台（VMware 及 Openstack）上部署和管理 Kubernetes 集群，实现 Kubernetes as a Service。
...
- [v1.5.0](https://github.com/KubeOperator/KubeOperator/blob/master/v1.5.0)
