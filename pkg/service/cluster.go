...
func (c *clusterService) Delete(name string, force bool, uninstall bool) error {
	...
	case constant.ClusterSourceExternal:
		_ = c.msgService.SendMsg(constant.ClusterDelete, constant.Cluster, cluster, true, map[string]string{"detailName": cluster.Name})
...
func (c *clusterService) errClusterDelete(cluster *model.Cluster, errStr error) {
	...
	_ = c.msgService.SendMsg(constant.ClusterUnInstall, constant.Cluster, cluster, false, map[string]string{"errMsg": errStr.Error(), "detailName": cluster.Name})
}
...
func (c *clusterService) uninstallCluster(cluster *model.Cluster, force bool) {
	...
	_ = c.msgService.SendMsg(constant.ClusterUnInstall, constant.Cluster, cluster, true, map[string]string{"detailName": cluster.Name})
