...
func NewChartmuseum(cluster dto.ClusterWithEndpoint, tool *model.ClusterTool) (*Chartmuseum, error) {
	p := &Chartmuseum{
		Tool: tool,
	}
...
func (c Chartmuseum) installChart() error {
	...
	_, err := c.HelmClient.Install(c.Tool.Name, constant.ChartmuseumChartName, valueMap)
	if err != nil {
		return nil
	}
	return nil
...
func (c Chartmuseum) createRoute() error {
