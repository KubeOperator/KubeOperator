...
var doc = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ClusterImport"
                        }
                    }
                ],
                "responses": {}
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ClusterLoad"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ClusterLoadInfo"
                        }
                    }
                }
            }
        ...
        "/clusters/node/recreate/{clusterName}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/clusters/status/{clusterName}/{nodeName}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.NtpServerCreate"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.NtpServerUpdate"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/settings/registry/change/password": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.RepoChangePassword"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.TemplateConfig"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        ...
        "dto.ClusterLoadInfo": {
            ...
            "properties": {
                ...
                "nodes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.NodesFromK8s"
                    }
                },
                "runtimeType": {
                    "type": "string"
        ...
        "dto.Node": {
            ...
            "properties": {
                ...
                "ip": {
                    "description": "Info v1.Node ` + "`" + `json:\"info\"` + "`" + `",
                    "type": "string"
                },
                "message": {
                    "type": "string"
