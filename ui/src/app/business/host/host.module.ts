...
@NgModule({
  declarations: [HostComponent, HostListComponent, HostCreateComponent, HostDeleteComponent, HostDetailComponent, HostStatusDetailComponent, HostImportComponent],
    imports: [
        CoreModule,
        SharedModule,
    ]
