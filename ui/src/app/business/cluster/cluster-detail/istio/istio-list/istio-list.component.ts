...
@Component({
    selector: 'app-istio-list',
    templateUrl: './istio-list.component.html',
    styleUrls: ['./istio-list.component.css']
})
export class IstioListComponent implements OnInit {
    ...
    @Output() disableEvent = new EventEmitter<IstioHelper[]>();
