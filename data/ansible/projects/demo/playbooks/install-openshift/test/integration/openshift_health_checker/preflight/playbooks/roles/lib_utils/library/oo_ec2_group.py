...
group_name:
  ...
  sample: My Security ClusterGroup
  type: string
...
def get_target_from_rule(module, client, rule, name, group, groups, vpc_id):
    ...
    if 'group_id' in rule and 'cidr_ip' in rule:
        ...
        # this is a foreign Security ClusterGroup. Since you can't fetch it you must create an instance of it
    ...
    for sg in security_groups:
        ...
        if groupName in groups:
            ...
            if groups[groupName].get('VpcId') == vpc_id:
                # ClusterGroup saved already matches current VPC, change nothing
                pass
    ...
    # Ensure requested group is present
        ...
        if group:
            ...
            if group['Description'] != description:
                module.warn("ClusterGroup description does not match existing group. Descriptions cannot be changed without deleting "
